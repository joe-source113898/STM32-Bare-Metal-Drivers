...
#define SRAM1_BASEADDR	0x20000000U	// 112 KB of SRAM 1
#define SRAM2_BASEADDR	0x20001C00U	// 16 KB of SRAM 2
#define ROM_BASEADDR	0x1FFF0000U	// 30 KB of  system memory
...
typedef struct {
	...
	__vo uint32_t BSRR;	// GPIO bit set reset register at 		0x18
...
// IRQ specific interrupt priorities
#define IRQ_PRI_NO_0 				0
#define IRQ_PRI_NO_1 				1
#define IRQ_PRI_NO_2 				2
#define IRQ_PRI_NO_3 				3
#define IRQ_PRI_NO_4 				4
#define IRQ_PRI_NO_5 				5
#define IRQ_PRI_NO_6 				6
#define IRQ_PRI_NO_7 				7
#define IRQ_PRI_NO_8 				8
#define IRQ_PRI_NO_9 				9
#define IRQ_PRI_NO_10 				10
#define IRQ_PRI_NO_11 				11
#define IRQ_PRI_NO_12 				12
#define IRQ_PRI_NO_13 				13
#define IRQ_PRI_NO_14 				14
#define IRQ_PRI_NO_15 				15
